      ...
      >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>approved inspection reports</CardDescription>
          </CardHeader>
          <CardContent>
            {reports.length === 0 ? (
                    ...
                    <div className="flex items-start justify-between gap-4 flex-wrap">
                      <div className="flex-1 min-w-50">
                        <div className="flex items-center gap-2 mb-2 flex-wrap">
                          ...
                          <Badge className="bg-green-500 rounded-md">Approved</Badge>
                        </div>
                        <div className="text-sm text-gray-600 space-y-1">
                          <p>Inspector: {report.inspector.name}</p>
                          <p>Submitted: {report.submittedAt ? new Date(report.submittedAt).toLocaleDateString() : 'N/A'}</p>
                          {report.reviewedBy && (
